...
export default function PrivacyPolicy() {
  return (
    <main id="privacy-policy-main" className="max-w-2xl mx-auto px-6 py-16 font-sans text-neutral-800">
      <div className="mb-6">
        <Link
          id="privacy-policy-back-link"
          href="/"
          className="text-xs text-neutral-500 hover:text-neutral-800 dark:hover:text-neutral-800 transition-colors inline-flex items-center gap-1"
        >
          ← Back to Write-Frankly
        </Link>
      </div>
      <h1 id="privacy-policy-heading" className="text-2xl font-bold mb-4 text-zinc-950 dark:text-zinc-450">Privacy Policy for Write-Frankly</h1>
      ...
      <section id="privacy-policy-content" className="space-y-4 text-sm leading-relaxed">
        <p id="privacy-policy-auth-statement" className="text-zinc-900 dark:text-zinc-500">
        ...
        <p id="privacy-policy-encryption-statement" className="text-zinc-900 dark:text-zinc-500">
        ...
        <p id="privacy-policy-revoke-statement" className="text-zinc-900 dark:text-zinc-500">
